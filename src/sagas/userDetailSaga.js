...
// export function* UserDetailDetialSaga({ payload, resolve }) {
//     try {
//         yield put({ type: START_LOADING, isLoading: true })
//         let response = yield api.GetUserDetailDetails(payload);

//         const {data, status} = response;

//         if (status === 200) {
//             yield put({ type: UserDetail_DETAILS_DATA_RESPONSE, payload: data })
//             resolve && resolve(response)
//             yield put({ type: RESET_LOADER, isLoading: false })
//         }
//         else {
//             yield put({ type: UserDetail_DETAILS_DATA_FAILED, payload: data })
//             resolve && resolve(response)
//             yield put({ type: RESET_LOADER, isLoading: false })
//         }
//     } catch (e) {
...
// export function* updateUserDetailSaga({ payload, resolve }) {
//     try {
//         yield put({ type: START_LOADING, isLoading: true })
//         let response = yield api.UpdeteUserDetail(payload);

//         const {data, status} = response;

//         if (status === 200) {
//             yield put({ type: UPDATE_USER_DETAILS_RESPONSE, payload: data })
//             resolve && resolve(response)
//             yield put({ type: RESET_LOADER, isLoading: false })
//         }
//         else {
//             yield put({ type: UPDATE_USER_DETAILS_FAILED, payload: data })
//             resolve && resolve(response)
//             yield put({ type: RESET_LOADER, isLoading: false })
//         }
//     } catch (e) {
...
// export function* deleteUserDetailSaga({ payload, resolve }) {
//     try {
//         yield put({ type: START_LOADING, isLoading: true })
//         let response = yield api.DeleteUserDetail(payload);

//         const {data, status} = response;

//         if (status === 200) {
//             yield put({ type: DELETE_USER_DETAILS_RESPONSE, payload: data })
//             resolve && resolve(response)
//             yield put({ type: RESET_LOADER, isLoading: false })
//         }
//         else {
//             yield put({ type: DELETE_USER_DETAILS_FAILED, payload: data })
//             resolve && resolve(response)
//             yield put({ type: RESET_LOADER, isLoading: false })
//         }
//     } catch (e) {
